...
- `simulate_and_infer.jl` gives an example on how to infer the parameters of a simulated population. The infered results are saved in a CSV file. Running this code usually takes around ten minutes (4GHz clock speed).
